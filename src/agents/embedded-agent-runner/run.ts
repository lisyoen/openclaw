        ...
        while (true) {
          ...
          return {
            ...
            meta: {
              ...
              stopReason,
              // P2.x: errored-turn assistant 본문을 overflow 검출(meta.error 미설정 경로) 용으로 전파.
              // 소비자: src/auto-reply/reply/agent-runner-execution.ts (E5)
              lastAssistantErrorMessage:
                sessionLastAssistant?.stopReason === "error"
                  ? sessionLastAssistant.errorMessage?.trim() || undefined
                  : undefined,
